...
- [health.py](https://github.com/rakibhossain72/ctrip/blob/main/app/api/health.py)
...
- [__init__.py](https://github.com/rakibhossain72/ctrip/blob/main/app/api/__init__.py)
</cite>
...
- [health.py](https://github.com/rakibhossain72/ctrip/blob/main/app/api/health.py#L4-L7)
...
- [engine.py](https://github.com/rakibhossain72/ctrip/blob/main/app/db/engine.py#L28-L32)
...
- Health route definition and response: [health.py](https://github.com/rakibhossain72/ctrip/blob/main/app/api/health.py#L4-L7)
- Application registration of health router: [server.py](https://github.com/rakibhossain72/ctrip/blob/main/server.py#L45-L47)
- Blockchain initialization during app lifespan: [server.py](https://github.com/rakibhossain72/ctrip/blob/main/server.py#L21-L42)
- Blockchain provider factory: [manager.py](https://github.com/rakibhossain72/ctrip/blob/main/app/blockchain/manager.py#L8-L33)
- Blockchain connectivity check method: [base.py](https://github.com/rakibhossain72/ctrip/blob/main/app/blockchain/base.py#L45-L50)
...
- Route definition: [health.py](https://github.com/rakibhossain72/ctrip/blob/main/app/api/health.py#L4-L7)
- Application registration: [server.py](https://github.com/rakibhossain72/ctrip/blob/main/server.py#L45-L47)
...
References:
- Lifespan initialization: [server.py](https://github.com/rakibhossain72/ctrip/blob/main/server.py#L21-L42)
- Blockchain provider factory: [manager.py](https://github.com/rakibhossain72/ctrip/blob/main/app/blockchain/manager.py#L8-L33)
- Base blockchain connectivity method: [base.py](https://github.com/rakibhossain72/ctrip/blob/main/app/blockchain/base.py#L45-L50)
- Database engine initialization: [engine.py](https://github.com/rakibhossain72/ctrip/blob/main/app/db/engine.py#L28-L32)
...
References:
- Handler response: [health.py](https://github.com/rakibhossain72/ctrip/blob/main/app/api/health.py#L4-L7)
...
- Lifespan initialization and error propagation: [server.py](https://github.com/rakibhossain72/ctrip/blob/main/server.py#L21-L42)
- Blockchain provider initialization: [manager.py](https://github.com/rakibhossain72/ctrip/blob/main/app/blockchain/manager.py#L8-L33)
- Database engine initialization: [engine.py](https://github.com/rakibhossain72/ctrip/blob/main/app/db/engine.py#L28-L32)
...
Operational references:
- Router registration: [server.py](https://github.com/rakibhossain72/ctrip/blob/main/server.py#L45-L47)
- Lifespan initialization: [server.py](https://github.com/rakibhossain72/ctrip/blob/main/server.py#L21-L42)
- Blockchain provider factory: [manager.py](https://github.com/rakibhossain72/ctrip/blob/main/app/blockchain/manager.py#L8-L33)
- Database engine initialization: [engine.py](https://github.com/rakibhossain72/ctrip/blob/main/app/db/engine.py#L28-L32)
