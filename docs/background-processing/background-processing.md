...
- [app/workers/__init__.py](file://app/workers/__init__.py#L3-L7)

**Section sources**
- [README.md](file://README.md#L1-L87)
- [docker-compose.yml](file://docker-compose.yml#L37-L51)
- [requirements.txt](file://requirements.txt#L24-L77)

## Core Components
- Worker initialization and broker setup
  - The workers package initializes a Redis broker and sets it globally for Dramatiq.
  - See [app/workers/__init__.py](file://app/workers/__init__.py#L1-L8).
...
- Listener worker
  ...
  - See [app/workers/listener.py](file://app/workers/listener.py#L21-L46).

- Sweeper worker
  - Actor sweeps confirmed payments per chain and marks them settled.
  - Schedules itself to run periodically.
  - See [app/workers/sweeper.py](file://app/workers/sweeper.py#L19-L40).
...
- Webhook worker
  ...
  - See [app/workers/webhook.py](file://app/workers/webhook.py#L13-L37).
...
- Services
  ...
  - See [app/services/blockchain/scanner.py](file://app/services/blockchain/scanner.py#L14-L134), [app/services/blockchain/sweeper.py](file://app/services/blockchain/sweeper.py#L11-L54), [app/services/webhook.py](file://app/services/webhook.py#L10-L45).
...
- Configuration and models
  ...
  - See [app/core/config.py](file://app/core/config.py#L10-L126), [app/db/models/payment.py](file://app/db/models/payment.py#L41-L74), [app/db/models/chain.py](file://app/db/models/chain.py#L9-L17), [app/db/models/token.py](file://app/db/models/token.py#L6-L15).

**Section sources**
- [app/workers/__init__.py](file://app/workers/__init__.py#L1-L8)
- [app/workers/listener.py](file://app/workers/listener.py#L21-L46)
- [app/workers/sweeper.py](file://app/workers/sweeper.py#L19-L40)
- [app/workers/webhook.py](file://app/workers/webhook.py#L13-L37)
- [app/services/blockchain/scanner.py](file://app/services/blockchain/scanner.py#L14-L134)
...
- [docker-compose.yml](file://docker-compose.yml#L37-L51)
- [app/workers/__init__.py](file://app/workers/__init__.py#L3-L7)
- [app/workers/listener.py](file://app/workers/listener.py#L42-L46)
- [app/workers/sweeper.py](file://app/workers/sweeper.py#L36-L40)
- [app/workers/webhook.py](file://app/workers/webhook.py#L33-L37)
...
- Broker setup
  ...
  - See [app/workers/__init__.py](file://app/workers/__init__.py#L3-L7).

- Worker startup
  - Docker Compose launches the Dramatiq CLI with the three worker modules.
  - See [docker-compose.yml](file://docker-compose.yml#L37-L51).

- Actor lifecycle
  - Each actor runs, performs work, logs outcomes, and schedules the next run using a delay option.
  - See [app/workers/listener.py](file://app/workers/listener.py#L42-L46), [app/workers/sweeper.py](file://app/workers/sweeper.py#L36-L40).
...
- Execution pattern
  ...
  - See [app/workers/listener.py](file://app/workers/listener.py#L21-L46), [app/services/blockchain/scanner.py](file://app/services/blockchain/scanner.py#L20-L134).
...
- Execution pattern
  ...
  - See [app/workers/sweeper.py](file://app/workers/sweeper.py#L19-L40), [app/services/blockchain/sweeper.py](file://app/services/blockchain/sweeper.py#L16-L54).
...
- Execution pattern
  ...
  - See [app/workers/webhook.py](file://app/workers/webhook.py#L13-L37), [app/services/webhook.py](file://app/services/webhook.py#L10-L45).
...
- Actor arguments
  ...
  - See [app/workers/webhook.py](file://app/workers/webhook.py#L14-L18).

- Payload signing
  - WebhookService signs payloads using HMAC-SHA256 when a secret is present.
  - See [app/services/webhook.py](file://app/services/webhook.py#L25-L31).

**Section sources**
- [app/workers/webhook.py](file://app/workers/webhook.py#L14-L18)
- [app/services/webhook.py](file://app/services/webhook.py#L25-L31)
...
- Listener and Sweeper actors
  ...
  - See [app/workers/listener.py](file://app/workers/listener.py#L21-L46), [app/workers/sweeper.py](file://app/workers/sweeper.py#L19-L40).
...
- Broker and queues
  ...
  - See [app/workers/__init__.py](file://app/workers/__init__.py#L3-L7), [docker-compose.yml](file://docker-compose.yml#L37-L51).
...
- Logging
  ...
  - See [app/workers/listener.py](file://app/workers/listener.py#L9-L13), [app/workers/sweeper.py](file://app/workers/sweeper.py#L10-L14), [app/services/webhook.py](file://app/services/webhook.py#L8-L9).
...
- Batch sizes and intervals
  ...
  - See [app/workers/listener.py](file://app/workers/listener.py#L15-L16).
...
- Webhook failures
  ...
  - See [app/workers/webhook.py](file://app/workers/webhook.py#L32-L37), [app/services/webhook.py](file://app/services/webhook.py#L39-L44).
...
- Payment detection gaps
  ...
  - See [app/services/blockchain/scanner.py](file://app/services/blockchain/scanner.py#L24-L95), [app/db/models/chain.py](file://app/db/models/chain.py#L9-L17), [chains.yaml](file://chains.yaml#L1-L24).

**Section sources**
- [app/workers/__init__.py](file://app/workers/__init__.py#L3-L7)
- [docker-compose.yml](file://docker-compose.yml#L37-L51)
- [app/workers/webhook.py](file://app/workers/webhook.py#L32-L37)
- [app/services/webhook.py](file://app/services/webhook.py#L39-L44)
- [app/services/blockchain/scanner.py](file://app/services/blockchain/scanner.py#L24-L95)
- [app/db/models/chain.py](file://app/db/models/chain.py#L9-L17)
...
- Settings keys used by workers
  ...
  - See [app/core/config.py](file://app/core/config.py#L34-L77).

- Chains configuration
  - Chains and tokens are defined in YAML and consumed by workers and services.
  - See [chains.yaml](file://chains.yaml#L1-L24).

**Section sources**
- [app/core/config.py](file://app/core/config.py#L34-L77)
- [chains.yaml](file://chains.yaml#L1-L24)
